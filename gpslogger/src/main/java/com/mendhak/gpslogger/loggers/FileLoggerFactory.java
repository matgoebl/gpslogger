...
public class FileLoggerFactory {
    public static List<IFileLogger> GetFileLoggers(Context context) {
        ...
        if (AppSettings.shouldLogToCustomUrl()) {
            ...
            loggers.add(new HttpUrlLogger(AppSettings.getCustomLoggingUrl(), AppSettings.getCustomLoggingInterval(), Session.getStartTimeStamp(), Session.getSatelliteCount(), batteryLevel, androidId));
        }
